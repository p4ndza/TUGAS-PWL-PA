...
<head>
    ...
    <title>Welcome - UMKM Lokal Kelompoks 9</title>
...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success shadow-sm">
        <div class="container">
            <a class="navbar-brand fw-bold" href="{{ route('home') }}">UMKM Lokal Kelompok 9</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('produk.index') }}">Katalog</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                    <a href="{{ route('produk.index') }}" class="btn btn-success btn-lg px-4 gap-3">Jelajahi Katalog</a>
