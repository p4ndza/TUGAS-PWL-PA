        ...
        <div class="lg:col-span-5 w-full max-w-md mx-auto">
            <div class="bg-cream-soft text-ink rounded-[2.5rem] shadow-2xl p-6 sm:p-8 border-2 border-gold/40 relative overflow-hidden">
                ...
                <form action="{{ route('register.submit') }}" method="POST" class="space-y-3">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama" id="nama" value="{{ old('nama') }}" required placeholder="Nama lengkap Anda"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <textarea name="alamat" id="alamat" rows="2" required placeholder="Alamat lengkap rumah Anda"
                                class="w-full pl-10 pr-4 py-2.5 rounded-2xl border border-gold/30 bg-white text-ink text-xs focus:outline-none focus:border-soga focus:ring-1 focus:ring-soga shadow-sm resize-none">{{ old('alamat') }}</textarea>
                        </div>
                    </div>
                ...
                <div class="mt-5 text-center text-[11px] text-ink/60 space-y-2">
                    <p>
                        Sudah punya akun? 
                        <a href="{{ route('login') }}" class="font-bold text-soga hover:underline">Masuk di sini</a>
                    </p>
