...
<body class="bg-gray-50 flex items-center justify-center min-h-screen">
    ...
    <div class="w-full max-w-md bg-white rounded-xl shadow-lg p-8 m-4">
        ...
        <p class="mt-6 text-center text-sm text-gray-600">
            Belum punya akun? 
            <a href="<?php echo e(route('register')); ?>" class="text-emerald-600 font-semibold hover:underline">Daftar sekarang</a>
        </p>
    </div>

</body>
</html><?php /**PATH C:\laragon\www\umkm-lokal\resources\views/auth/login.blade.php ENDPATH**/ ?>