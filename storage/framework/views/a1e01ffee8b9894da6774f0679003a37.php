...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'UMKM Lokal'); ?> - Kelompok 9</title>
        ...
        <div class="container mx-auto px-4 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex-shrink-0">
                    <a href="<?php echo e(route('home')); ?>" class="text-2xl font-black text-emerald-600 tracking-wider">
                        UMKM<span class="text-gray-800">LOKAL.</span>
                    </a>
                </div>

                <nav class="hidden md:flex space-x-8">
                    <a href="<?php echo e(route('home')); ?>" class="text-gray-700 hover:text-emerald-600 font-semibold transition">Home</a>
                    <a href="<?php echo e(route('produk.index')); ?>" class="text-gray-700 hover:text-emerald-600 font-semibold transition">Katalog</a>
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <div class="border-l pl-6">
                        <?php if(Auth::check()): ?>
                            <div class="relative group cursor-pointer">
                                <span class="text-gray-800 font-semibold flex items-center gap-2">
                                    Halo, <?php echo e(explode(' ', Auth::user()->nama)[0]); ?> 
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="text-gray-700 hover:text-emerald-600 font-semibold">Sign In</a>
                        <?php endif; ?>
                    </div>
                </div>
...
</html><?php /**PATH C:\laragon\www\TUGAS-PWL-PA-irpan\resources\views/layouts/app.blade.php ENDPATH**/ ?>