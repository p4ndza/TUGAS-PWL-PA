...
<body class="bg-gray-50 flex items-center justify-center min-h-screen py-10">
    ...
    <div class="w-full max-w-xl bg-white rounded-xl shadow-lg p-8 m-4">
        ...
        <form action="<?php echo e(route('register.submit')); ?>" method="POST" class="space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" name="no_telp" id="no_telp" required value="<?php echo e(old('no_telp')); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-colors">
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="alamat" id="alamat" rows="3" required
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-colors resize-none"><?php echo e(old('alamat')); ?></textarea>
            </div>
        ...
        <p class="mt-6 text-center text-sm text-gray-600">
            Sudah punya akun? 
            <a href="<?php echo e(route('login')); ?>" class="text-emerald-600 font-semibold hover:underline">Login di sini</a>
        </p>
    </div>

</body>
</html><?php /**PATH C:\laragon\www\umkm-lokal\resources\views/auth/register.blade.php ENDPATH**/ ?>