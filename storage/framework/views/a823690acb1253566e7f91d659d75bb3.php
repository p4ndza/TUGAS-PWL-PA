...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-inner">
            ...
            <ul class="nav-links">
                <li><a class="active" href="<?php echo e(route('home')); ?>">Beranda</a></li>
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <?php if(auth()->user()->isAdmin()): ?>
                        <li>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn-login" style="background: var(--soga); border-color: var(--soga);">
                                Dashboard
                            </a>
                        </li>
                    <?php endif; ?>
    ...
    <section class="hero">
        <div class="hero-inner">
            <div>
                ...
                <div class="hero-ctas">
                    <a href="<?php echo e(route('produk.index')); ?>" class="btn btn-primary">Jelajahi Katalog Motif</a>
...
<?php /**PATH C:\laragon\www\TUGAS-PWL-PA\resources\views/welcome.blade.php ENDPATH**/ ?>